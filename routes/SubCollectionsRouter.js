...
SubCollectionsRouter.get('/enabled',SubCollectionsController.getEnabledSubCollections)
SubCollectionsRouter.delete('/delete/:id',SubCollectionsController.deleteOne)
